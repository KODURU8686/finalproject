# Generated by Django 3.0 on 2021-06-12 14:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('req', models.CharField(choices=[('request', 'Request'), ('update', 'Update')], max_length=20)),
                ('org_name', models.CharField(max_length=200)),
                ('orglicense_no', models.CharField(max_length=20)),
                ('required_tablets', models.CharField(max_length=20)),
                ('email', models.EmailField(max_length=120)),
                ('oid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MedicineInfo',
            fields=[
                ...
                ('uf', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Export',
